...
The first thing you will need is a folder where you can save all the content at the same place. 
...
<Accordion icon="cloud" title="Example apps">
    Dropbox, Google Drive, OneDrive. You can find this repository on our
