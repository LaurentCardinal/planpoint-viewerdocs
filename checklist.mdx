...
<iframe <script src="https://fast.wistia.com/embed/medias/dnx96aqq7s.jsonp" async></script><script src="https://fast.wistia.com/assets/external/E-v1.js" async></script><div class="wistia_responsive_padding" style="padding:58.13% 0 0 0;position:relative;"><div class="wistia_responsive_wrapper" style="height:100%;left:0;position:absolute;top:0;width:100%;"><div class="wistia_embed wistia_async_dnx96aqq7s seo=false videoFoam=true" style="height:100%;position:relative;width:100%"><div class="wistia_swatch" style="height:100%;left:0;opacity:0;overflow:hidden;position:absolute;top:0;transition:opacity 200ms;width:100%;"><img src="https://fast.wistia.com/embed/medias/dnx96aqq7s/swatch" style="filter:blur(5px);height:100%;object-fit:contain;width:100%;" alt="" aria-hidden="true" onload="this.parentNode.style.opacity=1;" /></div></div></div></div> </iframe>
...
<AccordionGroup>
  ...
  <Accordion title="3D tours" icon="cube">
    ...
    The second one is the [next-gen 3D tour](https://www.planpoint.io/new-releases/next-gen-3d-tours) which allows for live choice of finishes, element selection and room measurements.
