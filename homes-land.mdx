...
<CardGroup cols={2}>
  <Card title="Example money-shot">
    ...
    Here's a [live example](https://www.planpoint.io/types/single-family).
  ...
  <Card title="Example bird's-eye view">
    ...
    Here's a [live example](https://app.planpoint.io/Mariners-2/Mariners-2).
...
Here's a [live example](https://app.planpoint.io/Mariners3/Mariners).
