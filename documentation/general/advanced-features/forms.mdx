...
The Form module allows you to create fully customizable forms to collect information from users interested in a specific unit. Forms can be embedded directly into your project flow, supporting advanced customization, logic rules, previews, and multi-language translations.
...
1. In your dashboard, go to Sales & Marketing. From there, you will find the Form module. <img src="/images/forms1.jpg" alt="Forms1" />
...
3. Define the condition and resulting action <img src="/images/forms4.jpg" alt="Forms4" />
...
- Questions labels <img src="/images/forms5.jpg" alt="Forms5" />
