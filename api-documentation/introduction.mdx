...
The Planpoint SDK is sending pre-configured React components that allow for easy rendering. It requires the ID of a project that has previously been configured in the dashboard.
